...
/**
 * Implement the generic versions of sorting algorithms Selection Sort,
 * Insertion Sort and Bubblesort Using the Comparable Interface
 * 
 * @author T.M. Rao
 * @version September 2006 Modified: 9/2007
 */
...
public class GenericSortingMethods {
	 ...
	 * 
	 * @param Comparable
	 *            [] a -- the array in which the swapping is done
	 * @param i
	 * @param j
	 *            -- the two locations in the array that will be swapped
	 */
	 ...
	 *            -- starting location
	 * @param end
	 *            -- end location This is called by the selectionSort method
	 */
	 ...
	 * 
	 * @param Comparable
	 *            [] a -- the array to be sorted calls: findSmallestLoc and swap
	 *            methods Time Complexity: O(N ** 2)
	 */
	 ...
	 * 
	 * @param Comparable
	 *            [] a -- the array to be sorted calls: insert and swap methods
	 ...
	 * 
	 * @param Comparable
	 *            [] a -- the sorted array into which the insertion is made
	 * @param x
	 *            -- the integer that is to be inserted
	 * @param end
	 *            -- array is assumed to be sorted from 0 to end
	 * 
	 ...
	 * position end. It compares a[0] with a[1], a[1] with a[2] ... and a[end-1]
	 * with a[end], and makes a swap if necessary. In case it swaps it will
	 * record that fact by setting didSwap to true. This is what is returned by
	 * the method.
	 * 
	 * @param Comparable
	 *            [] a -- the array to be sorted
	 * @param end
	 *            -- 0 to end is the part of the array to focus on. The elements
	 *            at positions end+1 ... will be sorted.
	 */
	...
	// -----------------------------------------------------------------
	/**
	 * The bubblesort method. It makes as many "pass"es as needed over the array
	 * until it is sorted.
	 * 
	 * @param Comparable
	 *            [] a -- the array to be sorted Time Complexity: O(N ** 2)
	 */

	public static void bubbleSort(Comparable[] a) {
		numComps = 0;
		boolean swapped = true; // Keep track of whether we made a swap in this
								// pass
								// Initially set to true, because we have to
								// make at
								// least one pass
		int passCount = 0; // Counts the number of passes. We need no more than
							// n-1 passes, where n is the length of the array
		int end = a.length - 1; // 0 to end is the part of the array to focus on
	...
	// -----------------------------------------------------------------
	/**
	 * This is the main quicksort method. It just sets the parameters properly
	 * and calls another quicksort method to sort it
	 */
	...
	// -----------------------------------------------------------------
	/**
	 * This is the recursive quicksort method. It first partitions the array
	 * into two parts such that all elements in the first part are less than all
	 * elements in the second part. It then recursively calls itself on both.
	 * 
	 * @param Comparable
	 *            [] a -- the array to be sorted Worst Case Time Complexity: O(N
	...
	// -----------------------------------------------------------------
	/**
	 * This is a private supporting method for quicksort. It just does the
	 * partitionaing of the array.
	 * 
	 * @param first
	...
	private static int partition(Comparable[] a, int first, int last) {
		Comparable<Comparable> pivot = a[first];
		int up = first;
		int down = last;
	...
	// -----------------------------------------------------------------
	/**
	 * The linear search (sequential search method. If the array is not sorted,
	 * this is the only way you can search.
	 * 
	 * @param Comparable
	 *            [] a -- the array in which we are searching
	 * @param x
	 *            -- The value that we are searching for Time Complexity: O(N)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *            [] a -- the array in which we are searching
	 * @param x
	 *            -- The value that we are searching for Time complexity O(log
	 *            N)
	 */
	public int binSearch(Comparable[] a, Comparable<Comparable> x) {
	...
	/**
	 * It is auumed that: Two parts of the array a: a[start1] to a[start2-1] and
	 * a[start2] to a[end2] are sorted. end2 >= start2 >= start1 This will merge
	 * those two parts to make one long sorted part between a[start1] to a[end2]
	 */
	@SuppressWarnings("unchecked")
